...
_PASSED_IN_ARGS_ARRAY = _args || [];
_PASSED_IN_ARGS = {};
for (var i = 0; i < _PASSED_IN_ARGS_ARRAY.length; i += 2) {
    var key = _PASSED_IN_ARGS_ARRAY[i],
        value = _PASSED_IN_ARGS_ARRAY[i + 1];

    if (key[0] === '-') {
        _PASSED_IN_ARGS[key.substr(1)] = value;
    }
}
