steal('./reporters.css').then(function(){

	steal.instrument.browserReporter = function(stats){
	...
	steal.instrument.consoleReporter = function(data){
		var pct = Math.round(data.total.lineCoverage*100)
